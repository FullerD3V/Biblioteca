 ...
 * @author fullerd3v
 */
public class EditSocioController implements Initializable {
    ...
    public void btnGuardarOnAction() throws Exception{
        ...
        if(formValido == true && flagDni == true && flagEmail == true && flagTel == true){
            ...
            jdbconnector.modificarSocio(id, dni, nombre, apellidos, email, telefono, direccion);

            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Editar datos");
            alert.setHeaderText("Socio modificado correctamente");
            alert.show();
    ...
    public void initData(SocioModel socio) {
